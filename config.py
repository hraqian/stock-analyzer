...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "objectives": {
        ...
        "swing_trade": {
            ...
            "strategy": {
                "rebalance_interval": 2,       # check nearly every bar for swing opportunities
                ...
                "trend_confirm_tolerance_pct": 0.0,  # no buffer — fast indicators already filter
                "score_thresholds": {
                    "short_below": 4.0,        # narrower HOLD zone for more trade signals
                    "hold_below": 5.5,         # (1.5-point HOLD vs 3.5-point base default)
                },
